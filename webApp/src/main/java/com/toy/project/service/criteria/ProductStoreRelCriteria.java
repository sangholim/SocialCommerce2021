...
/**
 * Criteria class for the {@link com.toy.project.domain.ProductStoreRel} entity. This class is used
 * in {@link com.toy.project.web.rest.ProductStoreRelResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /product-store-rels?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ProductStoreRelCriteria implements Serializable, Criteria {
    ...
    public ProductStoreRelCriteria() {}

    public ProductStoreRelCriteria(ProductStoreRelCriteria other) {
    ...
    @Override
    public ProductStoreRelCriteria copy() {
        return new ProductStoreRelCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ProductStoreRelCriteria that = (ProductStoreRelCriteria) o;
        return (
    ...
    public String toString() {
        return "ProductStoreRelCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
