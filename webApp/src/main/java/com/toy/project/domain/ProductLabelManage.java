...
/**
 * A ProductLabelManage.
 */
@Entity
@Table(name = "product_label_manage")
public class ProductLabelManage extends AbstractAuditingEntity implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductLabelManage)) {
            return false;
        }
        return id != null && id.equals(((ProductLabelManage) o).id);
    }
