...
public class ClazzChapterResource {
    ...
    public ClazzChapterResource(ClazzChapterService clazzChapterService, ClazzChapterRepository clazzChapterRepository) {
    ...
    public ResponseEntity<List<ClazzChapterDTO>> getAllClazzChapters(Pageable pageable) {
        log.debug("REST request to get a page of ClazzChapters");
        Page<ClazzChapterDTO> page = clazzChapterService.findAll(pageable);
