...
public class ProductTemplateResource {
    ...
    public ProductTemplateResource(ProductTemplateService productTemplateService, ProductTemplateRepository productTemplateRepository) {
    ...
    public ResponseEntity<List<ProductTemplateDTO>> getAllProductTemplates(Pageable pageable) {
        log.debug("REST request to get a page of ProductTemplates");
        Page<ProductTemplateDTO> page = productTemplateService.findAll(pageable);
