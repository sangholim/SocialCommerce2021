...
import com.toy.project.service.ClazzQueryService;
...
public class ClazzResource {
    ...
    public ClazzResource(ClazzService clazzService, ClazzRepository clazzRepository, ClazzQueryService clazzQueryService) {
     ...
     */
    @GetMapping("/clazzes")
    public ResponseEntity<List<ClazzDTO>> getAllClazzes(ClazzCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Clazzes by criteria: {}", criteria);
    ...
    /**
     * {@code GET  /clazzes/count} : count all the clazzes.
     *
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the count in body.
     */
    @GetMapping("/clazzes/count")
    public ResponseEntity<Long> countClazzes(ClazzCriteria criteria) {
        log.debug("REST request to count Clazzes by criteria: {}", criteria);
        return ResponseEntity.ok().body(clazzQueryService.countByCriteria(criteria));
    }
