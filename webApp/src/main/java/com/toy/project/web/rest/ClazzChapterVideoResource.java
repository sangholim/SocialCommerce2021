...
import com.toy.project.service.ClazzChapterVideoQueryService;
...
public class ClazzChapterVideoResource {
    ...
    private final ClazzChapterVideoQueryService clazzChapterVideoQueryService;
    ...
    public ClazzChapterVideoResource(
        ...
        ClazzChapterVideoQueryService clazzChapterVideoQueryService
    ) {
        this.clazzChapterVideoService = clazzChapterVideoService;
        this.clazzChapterVideoRepository = clazzChapterVideoRepository;
        this.clazzChapterVideoQueryService = clazzChapterVideoQueryService;
    }
    ...
    public ResponseEntity<List<ClazzChapterVideoDTO>> getAllClazzChapterVideos(ClazzChapterVideoCriteria criteria, Pageable pageable) {
        log.debug("REST request to get ClazzChapterVideos by criteria: {}", criteria);
        Page<ClazzChapterVideoDTO> page = clazzChapterVideoQueryService.findByCriteria(criteria, pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(ServletUriComponentsBuilder.fromCurrentRequest(), page);
        return ResponseEntity.ok().headers(headers).body(page.getContent());
    }

    /**
     * {@code GET  /clazz-chapter-videos/count} : count all the clazzChapterVideos.
     *
     * @param criteria the criteria which the requested entities should match.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the count in body.
     */
    @GetMapping("/clazz-chapter-videos/count")
    public ResponseEntity<Long> countClazzChapterVideos(ClazzChapterVideoCriteria criteria) {
        log.debug("REST request to count ClazzChapterVideos by criteria: {}", criteria);
        return ResponseEntity.ok().body(clazzChapterVideoQueryService.countByCriteria(criteria));
    }
