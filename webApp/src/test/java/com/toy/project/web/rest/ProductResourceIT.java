...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        ...
        product.setInstallmentMonth(DEFAULT_INSTALLMENT_MONTH);
        product.setSellDateFrom(DEFAULT_SELL_DATE_FROM);
        product.setSellDateTo(DEFAULT_SELL_DATE_TO);
        ...
        product.setShippingReleaseType(DEFAULT_SHIPPING_RELEASE_TYPE);
        product.setShippingStandardStartTime(DEFAULT_SHIPPING_STANDARD_START_TIME);
        product.setEtcShippingContent(DEFAULT_ETC_SHIPPING_CONTENT);
        product.setSeparateShippingPriceType(DEFAULT_SEPARATE_SHIPPING_PRICE_TYPE);
        product.setBundleShippingType(DEFAULT_BUNDLE_SHIPPING_TYPE);
        product.setDefaultShippingPrice(DEFAULT_DEFAULT_SHIPPING_PRICE);
        product.setFreeShippingPrice(DEFAULT_FREE_SHIPPING_PRICE);
        product.setJejuShippingPrice(DEFAULT_JEJU_SHIPPING_PRICE);
        product.setDifficultShippingPrice(DEFAULT_DIFFICULT_SHIPPING_PRICE);
        product.setRefundShippingPrice(DEFAULT_REFUND_SHIPPING_PRICE);
        product.setExchangeShippingPrice(DEFAULT_EXCHANGE_SHIPPING_PRICE);
        product.setExchangeShippingFileType(DEFAULT_EXCHANGE_SHIPPING_FILE_TYPE);
        product.setExchangeShippingFileUrl(DEFAULT_EXCHANGE_SHIPPING_FILE_URL);
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getUseDiscountInstant()).isEqualTo(DEFAULT_USE_DISCOUNT_INSTANT);
        assertThat(testProduct.getUseInstallment()).isEqualTo(DEFAULT_USE_INSTALLMENT);
        assertThat(testProduct.getInstallmentMonth()).isEqualTo(DEFAULT_INSTALLMENT_MONTH);
        assertThat(testProduct.getUseSellDate()).isEqualTo(DEFAULT_USE_SELL_DATE);
        ...
        assertThat(testProduct.getShippingReleaseType()).isEqualTo(DEFAULT_SHIPPING_RELEASE_TYPE);
        assertThat(testProduct.getShippingStandardStartTime()).isEqualTo(DEFAULT_SHIPPING_STANDARD_START_TIME);
        assertThat(testProduct.getEtcShippingContent()).isEqualTo(DEFAULT_ETC_SHIPPING_CONTENT);
        assertThat(testProduct.getSeparateShippingPriceType()).isEqualTo(DEFAULT_SEPARATE_SHIPPING_PRICE_TYPE);
        assertThat(testProduct.getBundleShippingType()).isEqualTo(DEFAULT_BUNDLE_SHIPPING_TYPE);
        ...
        assertThat(testProduct.getExchangeShippingFileType()).isEqualTo(DEFAULT_EXCHANGE_SHIPPING_FILE_TYPE);
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.setPrice(DEFAULT_PRICE);
        updatedProduct.setInstallmentMonth(DEFAULT_INSTALLMENT_MONTH);
        updatedProduct.setSellDateFrom(DEFAULT_SELL_DATE_FROM);
        updatedProduct.setSellDateTo(DEFAULT_SELL_DATE_TO);
        ...
        updatedProduct.setShippingReleaseType(DEFAULT_SHIPPING_RELEASE_TYPE);
        updatedProduct.setShippingStandardStartTime(DEFAULT_SHIPPING_STANDARD_START_TIME);
        updatedProduct.setEtcShippingContent(DEFAULT_ETC_SHIPPING_CONTENT);
        updatedProduct.setSeparateShippingPriceType(DEFAULT_SEPARATE_SHIPPING_PRICE_TYPE);
        updatedProduct.setBundleShippingType(DEFAULT_BUNDLE_SHIPPING_TYPE);
        updatedProduct.setDefaultShippingPrice(DEFAULT_DEFAULT_SHIPPING_PRICE);
        updatedProduct.setFreeShippingPrice(DEFAULT_FREE_SHIPPING_PRICE);
        updatedProduct.setJejuShippingPrice(DEFAULT_JEJU_SHIPPING_PRICE);
        updatedProduct.setDifficultShippingPrice(DEFAULT_DIFFICULT_SHIPPING_PRICE);
        updatedProduct.setRefundShippingPrice(DEFAULT_REFUND_SHIPPING_PRICE);
        updatedProduct.setExchangeShippingPrice(DEFAULT_EXCHANGE_SHIPPING_PRICE);
        updatedProduct.setExchangeShippingFileType(DEFAULT_EXCHANGE_SHIPPING_FILE_TYPE);
        updatedProduct.setExchangeShippingFileUrl(DEFAULT_EXCHANGE_SHIPPING_FILE_URL);
        ...
        assertThat(testProduct.getUseDiscountInstant()).isEqualTo(UPDATED_USE_DISCOUNT_INSTANT);
        assertThat(testProduct.getUseInstallment()).isEqualTo(UPDATED_USE_INSTALLMENT);
        assertThat(testProduct.getInstallmentMonth()).isEqualTo(UPDATED_INSTALLMENT_MONTH);
        assertThat(testProduct.getUseSellDate()).isEqualTo(UPDATED_USE_SELL_DATE);
        ...
        assertThat(testProduct.getShippingReleaseType()).isEqualTo(UPDATED_SHIPPING_RELEASE_TYPE);
        assertThat(testProduct.getShippingStandardStartTime()).isEqualTo(UPDATED_SHIPPING_STANDARD_START_TIME);
        assertThat(testProduct.getEtcShippingContent()).isEqualTo(UPDATED_ETC_SHIPPING_CONTENT);
        assertThat(testProduct.getSeparateShippingPriceType()).isEqualTo(UPDATED_SEPARATE_SHIPPING_PRICE_TYPE);
        assertThat(testProduct.getBundleShippingType()).isEqualTo(UPDATED_BUNDLE_SHIPPING_TYPE);
        ...
        assertThat(testProduct.getExchangeShippingFileType()).isEqualTo(UPDATED_EXCHANGE_SHIPPING_FILE_TYPE);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.setInstallmentMonth(UPDATED_INSTALLMENT_MONTH);
        partialUpdatedProduct.setSellDateFrom(UPDATED_SELL_DATE_FROM);
        partialUpdatedProduct.setSellDateTo(UPDATED_SELL_DATE_TO);
        ...
        partialUpdatedProduct.setShippingReleaseType(UPDATED_SHIPPING_RELEASE_TYPE);
        partialUpdatedProduct.setShippingStandardStartTime(UPDATED_SHIPPING_STANDARD_START_TIME);
        partialUpdatedProduct.setEtcShippingContent(UPDATED_ETC_SHIPPING_CONTENT);
        partialUpdatedProduct.setSeparateShippingPriceType(UPDATED_SEPARATE_SHIPPING_PRICE_TYPE);
        partialUpdatedProduct.setBundleShippingType(UPDATED_BUNDLE_SHIPPING_TYPE);
        partialUpdatedProduct.setDefaultShippingPrice(UPDATED_DEFAULT_SHIPPING_PRICE);
        partialUpdatedProduct.setFreeShippingPrice(UPDATED_FREE_SHIPPING_PRICE);
        partialUpdatedProduct.setJejuShippingPrice(UPDATED_JEJU_SHIPPING_PRICE);
        partialUpdatedProduct.setDifficultShippingPrice(UPDATED_DIFFICULT_SHIPPING_PRICE);
        partialUpdatedProduct.setRefundShippingPrice(UPDATED_REFUND_SHIPPING_PRICE);
        partialUpdatedProduct.setExchangeShippingPrice(UPDATED_EXCHANGE_SHIPPING_PRICE);
        partialUpdatedProduct.setExchangeShippingFileType(UPDATED_EXCHANGE_SHIPPING_FILE_TYPE);
        partialUpdatedProduct.setExchangeShippingFileUrl(UPDATED_EXCHANGE_SHIPPING_FILE_URL);
